...
Names <- c("Allan Hancock CC (n = 2)", "Butte CC (n = 1)" ,
           "Mt. SAC CC (n = 5)", "Clovis CC (n = 4)", 
           "Palo Verde CC (n = 2)",
           "Cal State San Bernardino (n = 5)", 
           "CSU Bakersfield (n = 2)", "Sacramento State (n = 5)",
           "CSU Dominguez Hills (n = 2)", 
           "San Francisco State (n = 8)", 
           "Cal State LA (n = 8)", "UC Berkeley (n = 6)", NA)
...
*Note: See the [methods page](Methods.qmd) for recruitment, data collection, and data cleaning.*
