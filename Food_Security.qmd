...
plot_frq(bns$two.item, geom.colors = plot_color, ylim=c(0,40)) + xlab('Food Insecure') + ylab("Frequency")
...
1.  [USDA's 10-item screener for food insecurity](https://www.ers.usda.gov/sites/default/files/_laserfiche/DataFiles/50764/26623_ad2012.pdf?v=3672.4)
